    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #0f172a 0%, #1e293b 50%, #0f172a 100%)' }}>
        ...
        <div className="relative z-10 flex flex-col justify-center items-center w-full px-12 text-white">
          ...
          <div className="mb-6 w-20 h-20 rounded-full flex items-center justify-center" style={{ background: 'rgba(34, 197, 94, 0.2)', border: '2px solid rgba(34, 197, 94, 0.4)' }}>
          ...
          <p className="text-slate-400 text-lg text-center max-w-xs leading-relaxed">
            Log in to your captain dashboard and start accepting rides.
          </p>

          <div className="mt-12 space-y-4 w-full max-w-xs">
            {[
              { icon: '💰', title: 'Earn more', desc: 'Competitive rates & bonuses' },
              { icon: '📍', title: 'Smart navigation', desc: 'Real-time route optimization' },
              { icon: '⭐', title: 'Build your rating', desc: 'Top captains earn more rides' },
            ].map((item) => (
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 sm:px-12 lg:px-16 py-12 bg-white">
        ...
        <div className="max-w-md w-full mx-auto">
          <div className="flex items-center gap-2 mb-1">
            ...
            <h2 className="text-3xl font-black text-gray-900 tracking-tight">Captain Sign in</h2>
          </div>
          <p className="text-gray-500 mb-8 text-sm">Not a captain yet? <Link to='/captain-signup' className="text-black font-semibold underline underline-offset-2">Register here</Link></p>
          ...
          <div className="mt-8 pt-6 border-t border-gray-100">
            <Link
              to='/login'
              className="w-full flex items-center justify-center gap-2 bg-orange-500 text-white font-semibold py-3 rounded-xl hover:bg-orange-600 transition-all duration-200"
            >
              <span>🙋</span> Sign in as User
            </Link>
          </div>
        </div>
      </div>
