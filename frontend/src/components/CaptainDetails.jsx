        ...
        <div className='bg-white rounded-2xl shadow-md p-5 border border-gray-100'>
            ...
            <div className='flex items-center justify-between mb-5'>
                ...
                <div className='text-right'>
                    ...
                    <h2 className='text-3xl font-bold text-gray-900 tracking-tight'>₹295.20</h2>
                </div>
            </div>
            ...
            <div className='flex items-start justify-around gap-2'>
                <StatBadge icon='ri-timer-2-line' value='10.2h' label='Hours Online' />
                <div className='w-px h-12 bg-gray-100 self-center' />
                <StatBadge icon='ri-route-line' value='8' label='Rides Done' />
                <div className='w-px h-12 bg-gray-100 self-center' />
                <StatBadge icon='ri-star-line' value='4.9' label='Rating' />
            </div>
        </div>
    )
}
